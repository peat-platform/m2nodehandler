...
//console.log('1):' + JSON.stringify(error_config));
...
//console.log('4):' + envelope);
//console.log('5):' + headersAndMongrel2);
...
//console.log('6):' + JSON.stringify(zmqMsg));
            callback(zmqMsg);
         };
